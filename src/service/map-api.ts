...
export class MapApi {
  ...
  public sendSearchRequest(query: string, mapItems: Ref<MapItem[]>) {
    ...
    return api.get(
      `/v1/search/local.json?query=${encodedQuery}&display=10&start=1&sort=random`,
      {
        headers: {
  ...
  public sendDirectionRequest(
    ...
    return api.get(
      `/map-direction/v1/driving?start=${startLng},${startLat}&goal=${endLng},${endLat}&option=trafast`,
      {
        headers: {
